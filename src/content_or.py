...
<p>It's the part of shrinkiatry that's hardest to copy, because it isn't a list of conditions or drugs. It's a map of how the profession actually works. Use the filters to narrow by theme, or just walk the whole floor.</p>
</div>
