# -*- coding: utf-8 -*-
"""Build entry v5: engine_v3 + banded pillar hubs + Atlas-level Operating Room (or4, fixed)."""
import os, sys
...
PAGES = []
for mod in (home5, pillars, content_articles, or4, content_tools, content_legal):
