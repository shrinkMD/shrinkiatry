# -*- coding: utf-8 -*-
"""Build entry v6: adds Decoder + State of Psychiatry sections, wired into nav and footer."""
import os, sys
...
import engine_v3
_real_v2 = engine_v3._b  # the real engine_v2 module object (render_header/footer read its globals)

# --- Extend navigation and footer with the two new flagship sections ---
_real_v2.NAV = [
