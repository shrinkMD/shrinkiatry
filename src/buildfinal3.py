# -*- coding: utf-8 -*-
"""Build entry: engine_v3 (network links + author IDs) + banded pillar hubs."""
import os, sys
...
sys.modules["engine_v2"] = engine_v3   # pillars' `import engine_v2` -> engine_v3
...
PAGES = []
for mod in (home5, pillars, content_articles, or2, content_tools, content_legal):
